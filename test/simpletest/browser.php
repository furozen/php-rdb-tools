...
class SimpleBrowserHistory
{
    ...
    function recordEntry($url, $parameters) {
        $this->dropFuture();
        array_push($this->sequence, array('url' => $url, 'parameters' => $parameters));
        $this->position++;
    }
...
class SimpleBrowser
{
    ...
    protected function loadPage($url, $parameters) {
        ...
        $this->history->recordEntry($this->page->getUrl(), $this->page->getRequestData());
     ...
     * @param string $name        Name of cookie to selectTyped.
    ...
    function clickSubmit($label = 'Submit', $additional = false) {
        ...
        $success = $this->load($form->getAction(), $form->submitButton(new SimpleByLabel($label), $additional));
    ...
    function clickSubmitByName($name, $additional = false) {
        ...
        $success = $this->load($form->getAction(), $form->submitButton(new SimpleByName($name), $additional));
        return ($success ? $this->getContent() : $success);
    }
    ...
    function clickSubmitById($id, $additional = false) {
        ...
        $success = $this->load($form->getAction(), $form->submitButton(new SimpleById($id), $additional));
        return ($success ? $this->getContent() : $success);
    }
    ...
    function clickImage($label, $x = 1, $y = 1, $additional = false) {
        ...
        $success = $this->load($form->getAction(), $form->submitImage(new SimpleByLabel($label), $x, $y, $additional));
        return ($success ? $this->getContent() : $success);
    }
    ...
    function clickImageByName($name, $x = 1, $y = 1, $additional = false) {
        ...
        $success = $this->load($form->getAction(), $form->submitImage(new SimpleByName($name), $x, $y, $additional));
        return ($success ? $this->getContent() : $success);
    }
    ...
    function clickImageById($id, $x = 1, $y = 1, $additional = false) {
        ...
        $success = $this->load($form->getAction(), $form->submitImage(new SimpleById($id), $x, $y, $additional));
        return ($success ? $this->getContent() : $success);
    }
    ...
    function submitFormById($id, $additional = false) {
        ...
        $success = $this->load($form->getAction(), $form->submit($additional));
        return ($success ? $this->getContent() : $success);
    }
