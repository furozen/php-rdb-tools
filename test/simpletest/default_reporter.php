...
class DefaultReporter extends SimpleReporterDecorator
{
    ...
    function __construct() {
        if (SimpleReporter::inCli()) {
            ...
            $reporter = new SelectiveReporter(SimpleTest::preferred('HtmlReporter'), isset($_GET['c']) ? $_GET['c'] : null, isset($_GET['t']) ? $_GET['t'] : null);
            if ((isset($_GET['skips']) && $_GET['skips'] == 'no') || (isset($_GET['show-skips']) && $_GET['show-skips'] == 'no')) {
                $reporter = new NoSkipsReporter($reporter);
            }
        }
